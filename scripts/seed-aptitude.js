...
// PROVENANCE RULE: the formulas and worked examples below are verifiable maths
// and stay. Claims about how often a topic appears in a given exam ("2-3
// questions every NQT", "always has 1-2 …") are unsourced and change per
// hiring cycle — they must not appear here. Naming a topic as standard for an
// exam is fine; quantifying its frequency is not.
const APTITUDE_ENTRIES = [
  { content: "Ratio and Proportion Shortcut: To divide N in ratio a:b, first part = N×a/(a+b), second part = N×b/(a+b). Example: 720 in 2:3 → 720×2/5=288, 720×3/5=432. For 3-part ratio a:b:c, total parts = a+b+c, each part = N×(part/total). Ratios are a standard TCS NQT aptitude topic.", company: null, difficulty: "easy" },
  ...
  { content: "Percentage Shortcut: X% of Y = Y% of X. So 24% of 50 = 50% of 24 = 12. Saves time when one side is easier. Fraction shortcuts: 1/2=50%, 1/3=33.33%, 1/4=25%, 1/5=20%, 1/6=16.67%, 1/8=12.5%, 1/10=10%. Percentages are a standard TCS NQT aptitude topic.", company: null, difficulty: "easy" },
  { content: "Successive Percentage Change: a% then b% = (a+b+ab/100)% net. Example: 20% then 30% increase = 20+30+600/100 = 56% net increase. NOT 50%. Applying the formula is far faster than working the two steps out longhand.", company: null, difficulty: "medium" },
  ...
  { content: "Time Speed Distance: D = S × T. Convert km/hr to m/s: multiply by 5/18. Convert m/s to km/hr: multiply by 18/5. Average speed for same distance at speeds a,b = 2ab/(a+b). NOT (a+b)/2. A standard topic in TCS NQT and Infosys SP aptitude.", company: null, difficulty: "easy" },
  ...
  { content: "Train Problems: Train crosses pole: Time = Length/Speed. Crosses platform: Time = (L_train + L_platform)/Speed. Two trains crossing: Time = (L1+L2)/Relative speed. Same direction: |S1-S2|. Opposite: S1+S2. Train problems are a standard TCS NQT aptitude topic.", company: null, difficulty: "medium" },
  ...
  { content: "Simple Interest: SI = PNR/100. Compound Interest: CI = P(1+R/100)^N - P. Shortcut for 2 years: CI-SI = P×(R/100)². If SI for 2 years at 10% on ₹5000 = ₹1000, then CI-SI = 5000×0.01 = ₹50. Simple and compound interest are standard TCS NQT aptitude topics.", company: null, difficulty: "medium" },
  ...
  { content: "Permutation nPr = n!/(n-r)! (order matters). Combination nCr = n!/(r!(n-r)!) (order doesn't). nCr = nC(n-r). Circular permutation = (n-1)!. With identical objects: n!/(p!×q!). Permutations and combinations are a standard TCS NQT aptitude topic.", company: null, difficulty: "hard" },
