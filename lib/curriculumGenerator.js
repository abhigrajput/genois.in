...
Never silently switch languages.`;
  ...
  const difficultyInstruction = `${buildDifficultyDirective(track, dayNumber, effectiveLevel)}${solveRateNote}`;

  const messyDataInstruction = buildMessyDataDirective(track, dayNumber, effectiveLevel);
