export const SKILL_TIERS = {
  fresher: {
    ...
    companies: 'Internships at small startups',
    expectedPackage: '2-4 LPA',
  },
  junior: {
    ...
    companies: 'TCS, Infosys, Wipro, Capgemini, small product startups',
    expectedPackage: '3.5-7 LPA',
  },
  'mid-level': {
    ...
    companies: 'Paytm, Zomato, Swiggy, Razorpay, decent product companies',
    expectedPackage: '8-18 LPA',
  },
  senior: {
    ...
    companies: 'Flipkart, CRED, PhonePe, Microsoft India, Adobe',
    expectedPackage: '20-40 LPA',
  },
  expert: {
    label: 'Expert / Staff',
    min: 2500, max: 99999,
    ...
    companies: 'Google, Amazon, Microsoft, Meta, top product companies',
    expectedPackage: '40-80+ LPA',
  },
};
