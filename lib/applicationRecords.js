...
/**
 * PostgREST's missing-relation signals — "this table's migration has not been
 * applied here". Written for 20260808 (job_applications) and shared with any
 * other route that has to degrade gracefully rather than 500 on a missing
 * table; nothing about it is specific to the tracker.
 */
