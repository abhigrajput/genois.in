        ...
        <div style={{ background: '#070f1f', border: '1px solid rgba(0,240,255,0.1)', borderRadius: 14, padding: 20, marginBottom: 24 }}>
          <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', alignItems: 'flex-end' }}>
            <div style={{ flex: 1, minWidth: 140 }}>
              ...
              <select value={filters.domain} onChange={e => setFilters(p => ({ ...p, domain: e.target.value }))} style={{ width: '100%', padding: '10px 12px', borderRadius: 8, border: '1px solid rgba(0,240,255,0.15)', background: '#070f1f', color: '#e8e8ed', fontSize: 13, outline: 'none' }}>
            ...
            <div style={{ flex: 1, minWidth: 140 }}>
              ...
              <select value={filters.minScore} onChange={e => setFilters(p => ({ ...p, minScore: parseInt(e.target.value) }))} style={{ width: '100%', padding: '10px 12px', borderRadius: 8, border: '1px solid rgba(0,240,255,0.15)', background: '#070f1f', color: '#e8e8ed', fontSize: 13, outline: 'none' }}>
            ...
            <div style={{ flex: 1, minWidth: 140 }}>
              ...
              <select value={filters.tier || ''} onChange={e => setFilters(p => ({ ...p, tier: e.target.value }))} style={{ width: '100%', padding: '10px 12px', borderRadius: 8, border: '1px solid rgba(0,240,255,0.15)', background: '#070f1f', color: '#e8e8ed', fontSize: 13, outline: 'none' }}>
            ...
            <div style={{ flex: 2, minWidth: 180 }}>
              ...
              <input value={filters.college} onChange={e => setFilters(p => ({ ...p, college: e.target.value }))} placeholder="Search college name..." style={{ width: '100%', padding: '10px 12px', borderRadius: 8, border: '1px solid rgba(0,240,255,0.15)', background: 'rgba(255,255,255,0.02)', color: '#e8e8ed', fontSize: 13, outline: 'none', boxSizing: 'border-box' }} />
            </div>
            <button onClick={applyFilters} style={{ padding: '10px 24px', borderRadius: 8, border: 'none', cursor: 'pointer', background: 'linear-gradient(135deg,#00f0ff,#ff6b4a)', color: '#020812', fontFamily: 'var(--font-heading)', fontSize: 13, fontWeight: 700, flexShrink: 0 }}>
              Search →
            </button>
          </div>
        </div>
                  ...
                  <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 12 }}>
                    <div style={{ flex: 1 }}>
                      ...
                      <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
                        ...
                        <span style={{ fontSize: 10, padding: '2px 8px', borderRadius: 20, background: 'rgba(0,240,255,0.06)', color: '#00f0ff', fontFamily: 'var(--font-mono)' }}>
                          Rank #{s.rank}
                        </span>
                        {s.skillTier && (
        ...
        <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.85)', zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20 }}>
          <div style={{ background: '#070f1f', border: '1px solid rgba(0,240,255,0.2)', borderRadius: 16, padding: 28, width: '100%', maxWidth: 480 }}>
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <textarea value={message} onChange={e => setMessage(e.target.value)} placeholder={`Hi ${contactModal.name}, we found your GENOIS profile and are interested in discussing a role at ${company?.name}...`} rows={4} style={{ width: '100%', padding: '10px 14px', borderRadius: 8, border: '1px solid rgba(0,240,255,0.15)', background: 'rgba(255,255,255,0.03)', color: '#e8e8ed', fontSize: 13, outline: 'none', resize: 'vertical', boxSizing: 'border-box' }} />
            </div>
            <div style={{ display: 'flex', gap: 10 }}>
              ...
              <button onClick={contactStudent} disabled={!!contactingId} style={{ flex: 2, padding: '12px', borderRadius: 10, border: 'none', cursor: 'pointer', background: 'linear-gradient(135deg,#00f0ff,#ff6b4a)', color: '#020812', fontFamily: 'var(--font-heading)', fontSize: 13, fontWeight: 700 }}>
