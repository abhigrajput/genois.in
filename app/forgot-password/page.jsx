      ...
      <div style={{ width: '100%', maxWidth: 400 }}>
        ...
        {sent ? (
          <div style={{ background: 'rgba(29,158,117,0.1)', border: '1px solid rgba(29,158,117,0.3)', borderRadius: 14, padding: 24, textAlign: 'center' }}>
            ...
            <div style={{ fontFamily: 'Syne,sans-serif', fontSize: 18, fontWeight: 700, color: '#1D9E75', marginBottom: 8 }}>
              Check your email
            </div>
            <div style={{ color: '#5a7a9a', fontSize: 14, marginBottom: 20, lineHeight: 1.6 }}>
              If <strong style={{ color: '#e8f4ff' }}>{email}</strong> is registered we have sent a reset link. Check your inbox and spam folder.
            </div>
            <Link href="/login" style={{ color: '#00f0ff', textDecoration: 'none', fontSize: 14, fontFamily: 'Syne,sans-serif', fontWeight: 600 }}>
              ← Back to Login
            </Link>
          </div>
        ) : (
          <div style={{ background: '#070f1f', border: '1px solid rgba(0,240,255,0.12)', borderRadius: 14, padding: 28 }}>
            <div style={{ marginBottom: 16 }}>
              <div style={{ fontSize: 12, color: '#5a7a9a', fontFamily: 'JetBrains Mono,monospace', marginBottom: 6 }}>EMAIL ADDRESS</div>
              <input
                type="email"
                value={email}
            ...
            <button onClick={submit} disabled={loading} style={{ width: '100%', padding: '14px', borderRadius: 12, border: 'none', cursor: 'pointer', background: loading ? 'rgba(0,240,255,0.2)' : 'linear-gradient(135deg,#00f0ff,#7b5cff)', color: '#020812', fontFamily: 'Syne,sans-serif', fontSize: 15, fontWeight: 700, marginBottom: 16 }}>
