    ...
    await resend.emails.send({
      ...
      html: `
        <div style="background:#0a0a0f;color:#e8e8ed;font-family:Arial,sans-serif;max-width:600px;margin:0 auto;padding:40px 24px;border-radius:12px;">
          <div style="font-size:24px;font-weight:800;margin-bottom:8px;"><span style="color:#00d9a3">GEN</span><span style="color:#e8e8ed">OIS</span></div>
          <div style="height:2px;background:linear-gradient(90deg,#00d9a3,transparent);margin-bottom:24px;"></div>
          <h2 style="color:#00d9a3;margin-bottom:16px;">New Feedback Received</h2>
          <table style="width:100%;border-collapse:collapse;margin-bottom:20px;">
            <tr><td style="padding:8px 0;color:#5a7a9a;width:120px;">From:</td><td style="color:#e8e8ed;">${safeEmail}</td></tr>
            <tr><td style="padding:8px 0;color:#5a7a9a;">User ID:</td><td style="color:#e8e8ed;">${safeUserId}</td></tr>
            <tr><td style="padding:8px 0;color:#5a7a9a;">Type:</td><td style="color:#00d9a3;font-weight:700;">${safeType}</td></tr>
            <tr><td style="padding:8px 0;color:#5a7a9a;">Subject:</td><td style="color:#e8e8ed;">${safeSubject}</td></tr>
          </table>
          <div style="background:#12121a;border:1px solid rgba(0,217,163,0.15);border-radius:10px;padding:20px;margin-bottom:20px;">
            <div style="font-size:12px;color:#5a7a9a;margin-bottom:8px;letter-spacing:2px;">MESSAGE</div>
            <div style="color:#e8e8ed;font-size:15px;line-height:1.7;">${safeMessage}</div>
          </div>
