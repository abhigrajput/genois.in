...
export default function DuelPage() {
  ...
  if (finished || duel.iFinished) {
    ...
    return (
      <div style={{ maxWidth: 600, margin: '0 auto', fontFamily: 'var(--font-body)', textAlign: 'center', paddingTop: 40 }}>
        {waitingForOpponent ? (
          <>
            <div style={{ fontSize: 56, marginBottom: 16 }}>⏳</div>
            <h2 style={{ fontFamily: 'var(--font-heading)', fontSize: 22, fontWeight: 800, color: '#e8e8ed', marginBottom: 8 }}>
            ...
            <div style={{ color: '#3a4a5a', fontSize: 12, fontFamily: 'var(--font-mono)', animation: 'pulse 2s infinite' }}>
          ...
          <>
            ...
            <h2 style={{ fontFamily: 'var(--font-heading)', fontSize: 28, fontWeight: 800, color: isDraw ? '#EF9F27' : won ? '#1D9E75' : '#ff2d78', marginBottom: 8 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 24 }}>
              ...
              <div style={{ background: '#070f1f', border: '1px solid rgba(255,45,120,0.15)', borderRadius: 12, padding: 20 }}>
                ...
                <div style={{ fontFamily: 'var(--font-heading)', fontSize: 32, fontWeight: 800, color: '#ff2d78' }}>{duel.theirScore}</div>
              </div>
            </div>
            <div style={{ display: 'flex', gap: 10, justifyContent: 'center', flexWrap: 'wrap' }}>
              ...
              }} style={{ padding: '12px 24px', borderRadius: 10, border: '1px solid rgba(37,211,102,0.3)', background: 'rgba(37,211,102,0.08)', color: '#25D366', cursor: 'pointer', fontFamily: 'var(--font-heading)', fontSize: 14 }}>
                Share Result
              </button>
            </div>
          </>
  ...
  if (!started) {
    return (
      <div style={{ maxWidth: 600, margin: '0 auto', fontFamily: 'var(--font-body)', textAlign: 'center', paddingTop: 40 }}>
        ...
        <h2 style={{ fontFamily: 'var(--font-heading)', fontSize: 26, fontWeight: 800, color: '#e8e8ed', marginBottom: 8 }}>
        ...
        <div style={{ background: '#070f1f', border: '1px solid rgba(255,45,120,0.2)', borderRadius: 14, padding: 24, marginBottom: 28, textAlign: 'left' }}>
          <div style={{ fontFamily: 'var(--font-mono)', fontSize: 10, color: '#ff2d78', letterSpacing: 2, marginBottom: 12 }}>DUEL RULES</div>
        ...
        <button onClick={startDuel} style={{ padding: '16px 40px', borderRadius: 12, border: 'none', cursor: 'pointer', background: 'linear-gradient(135deg,#ff2d78,#EF9F27)', color: '#fff', fontFamily: 'var(--font-heading)', fontSize: 16, fontWeight: 800, boxShadow: '0 0 30px rgba(255,45,120,0.3)' }}>
          Start Duel ⚔️
        </button>
      </div>
    );
