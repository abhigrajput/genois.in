    ...
    <div style={{ maxWidth: 700, margin: '0 auto', fontFamily: 'var(--font-body)' }}>
          ...
          <div style={{ flex: 1 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 4, flexWrap: 'wrap' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 4, padding: '3px 10px', borderRadius: 20, background: 'rgba(0,119,181,0.15)', border: '1px solid rgba(0,119,181,0.4)', color: '#0077B5' }}>
                ...
                <span style={{ fontSize: 11, fontFamily: 'var(--font-mono)', fontWeight: 700 }}>GENOIS VERIFIED</span>
              </div>
            </div>
      ...
      <div style={{ background: '#070f1f', border: '1px solid rgba(0,119,181,0.2)', borderRadius: 14, padding: 20, marginBottom: 16 }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
          <div style={{ fontFamily: 'var(--font-mono)', fontSize: 10, color: '#0077B5', letterSpacing: 2 }}>LINKEDIN POST CAPTION</div>
