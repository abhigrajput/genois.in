  ...
  return (
    <div style={{ fontFamily: 'Outfit,sans-serif', width: '100%' }}>
      ...
      <div style={{ background: `linear-gradient(135deg,${currentTier.color}10,transparent)`, border: `2px solid ${currentTier.color}30`, borderRadius: 16, padding: 24, marginBottom: 28, textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ fontFamily: 'JetBrains Mono,monospace', fontSize: 10, color: '#5a7a9a', letterSpacing: 2, marginBottom: 6 }}>YOU ARE CURRENTLY</div>
        <div style={{ fontFamily: 'Syne,sans-serif', fontSize: 28, fontWeight: 800, color: currentTier.color, marginBottom: 6 }}>{currentTier.label}</div>
        ...
        <div style={{ display: 'inline-flex', gap: 14, padding: '8px 16px', background: 'rgba(255,255,255,0.04)', borderRadius: 20 }}>
          <span style={{ fontSize: 12, color: '#5a7a9a', fontFamily: 'JetBrains Mono,monospace' }}>Score: <strong style={{ color: currentTier.color }}>{typeof score === 'number' ? score : 0}</strong></span>
        </div>
      </div>

      <div style={{ fontFamily: 'JetBrains Mono,monospace', fontSize: 11, color: '#5a7a9a', letterSpacing: 2, marginBottom: 16 }}>ALL LEVELS</div>
              ...
              <div style={{ display: 'flex', alignItems: 'flex-start', gap: 16, flexWrap: 'wrap' }}>
                ...
                <div style={{ flex: 1, minWidth: 200 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 4, flexWrap: 'wrap' }}>
                    <div style={{ fontFamily: 'Syne,sans-serif', fontSize: 16, fontWeight: 700, color: t.color }}>{t.label}</div>
                    {isCurrent && <span style={{ fontSize: 10, padding: '2px 8px', borderRadius: 20, background: 'rgba(0,240,255,0.1)', color: '#00f0ff', fontFamily: 'JetBrains Mono,monospace' }}>YOU ARE HERE</span>}
                  </div>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(140px,1fr))', gap: 8, fontSize: 12 }}>
                    <div>
                      <div style={{ fontSize: 10, color: '#5a7a9a', fontFamily: 'JetBrains Mono,monospace' }}>Score Range</div>
                    ...
                    <div>
                      <div style={{ fontSize: 10, color: '#5a7a9a', fontFamily: 'JetBrains Mono,monospace' }}>Target Companies</div>
