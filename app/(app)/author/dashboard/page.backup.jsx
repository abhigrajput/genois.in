...
export default function AuthorDashboard() {
    ...
    return (
      <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '60vh', color: '#5a7a9a', fontFamily: 'Outfit,sans-serif' }}>
        <div style={{ textAlign: 'center' }}>
          ...
          <div style={{ fontFamily: 'JetBrains Mono,monospace', fontSize: '12px' }}>VERIFYING AUTHOR ROLE</div>
        </div>
      </div>
    );
  }
  ...
  if (!isAuthor) {
    return (
      <div style={{ maxWidth: '640px', margin: '60px auto', textAlign: 'center', padding: '40px', background: '#070f1f', border: '1px solid rgba(0,240,255,0.1)', borderRadius: '16px', fontFamily: 'Outfit,sans-serif' }}>
        <div style={{ fontSize: '64px', marginBottom: '24px' }}>✍️</div>
        <h1 style={{ fontFamily: 'Syne,sans-serif', fontSize: '28px', fontWeight: 800, color: '#e8f4ff', marginBottom: '16px' }}>Become a GENOIS DSA Author</h1>
  ...
  return (
    <div style={{ fontFamily: 'Outfit,sans-serif', width: '100%' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: '16px', marginBottom: '24px', flexWrap: 'wrap' }}>
        <div>
          <h1 style={{ fontFamily: 'Syne,sans-serif', fontSize: '26px', fontWeight: 800, color: '#e8f4ff', marginBottom: '4px' }}>✍️ Creator Studio</h1>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px', marginBottom: '32px' }}>
        {[
          { label: 'Total Articles', value: stats.total, color: '#7b5cff', icon: '📝' },
          ...
          <div key={s.label} style={{ background: '#070f1f', border: `1px solid rgba(0,240,255,0.08)`, borderLeft: `4px solid ${s.color}`, borderRadius: '12px', padding: '16px 20px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div>
              <div style={{ fontFamily: 'JetBrains Mono,monospace', fontSize: '10px', color: '#5a7a9a', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: '4px' }}>{s.label}</div>
              <div style={{ fontFamily: 'Syne,sans-serif', fontSize: '24px', fontWeight: 800, color: '#e8f4ff' }}>{s.value}</div>
            </div>
      ...
      <div style={{ background: '#070f1f', border: '1px solid rgba(0,240,255,0.08)', borderRadius: '14px', overflow: 'hidden' }}>
        <div style={{ padding: '20px 24px', borderBottom: '1px solid rgba(255,255,255,0.05)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <h2 style={{ fontFamily: 'Syne,sans-serif', fontSize: '16px', fontWeight: 700, color: '#e8f4ff', margin: 0 }}>Manage DSA Publications</h2>
          <span style={{ fontSize: '12px', color: '#5a7a9a', fontFamily: 'JetBrains Mono,monospace' }}>{posts.length} POSTS FOUND</span>
        </div>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', minWidth: '700px' }}>
              <thead>
                <tr style={{ borderBottom: '1px solid rgba(255,255,255,0.04)', background: 'rgba(0,0,0,0.1)' }}>
                  <th style={{ padding: '14px 24px', fontSize: '11px', color: '#5a7a9a', fontFamily: 'JetBrains Mono,monospace', fontWeight: 600 }}>ARTICLE TITLE</th>
                  <th style={{ padding: '14px 16px', fontSize: '11px', color: '#5a7a9a', fontFamily: 'JetBrains Mono,monospace', fontWeight: 600 }}>TOPIC</th>
                  <th style={{ padding: '14px 16px', fontSize: '11px', color: '#5a7a9a', fontFamily: 'JetBrains Mono,monospace', fontWeight: 600 }}>DIFFICULTY</th>
                  <th style={{ padding: '14px 16px', fontSize: '11px', color: '#5a7a9a', fontFamily: 'JetBrains Mono,monospace', fontWeight: 600 }}>STATUS</th>
                  <th style={{ padding: '14px 16px', fontSize: '11px', color: '#5a7a9a', fontFamily: 'JetBrains Mono,monospace', fontWeight: 600, textAlign: 'center' }}>VIEWS</th>
                  <th style={{ padding: '14px 16px', fontSize: '11px', color: '#5a7a9a', fontFamily: 'JetBrains Mono,monospace', fontWeight: 600 }}>PUBLISHED</th>
                  <th style={{ padding: '14px 24px', fontSize: '11px', color: '#5a7a9a', fontFamily: 'JetBrains Mono,monospace', fontWeight: 600, textAlign: 'right' }}>ACTIONS</th>
                </tr>
              </thead>
              <tbody>
                {posts.map((post) => {
                  ...
                  return (
                    <tr key={post.id} style={{ borderBottom: '1px solid rgba(255,255,255,0.03)', transition: 'background 0.15s' }} onMouseOver={(e) => e.currentTarget.style.background = 'rgba(255,255,255,0.01)'} onMouseOut={(e) => e.currentTarget.style.background = 'transparent'}>
                      <td style={{ padding: '16px 24px' }}>
                        <div style={{ fontSize: '14px', fontWeight: 600, color: '#e8f4ff', marginBottom: '4px' }}>{post.title}</div>
                        <div style={{ fontSize: '11px', color: '#5a7a9a', fontFamily: 'JetBrains Mono,monospace' }}>/{post.slug}</div>
                      </td>
                      ...
                      <td style={{ padding: '16px 16px', textAnchor: 'middle', textAlign: 'center', fontFamily: 'JetBrains Mono,monospace', fontSize: '13px', color: '#e8f4ff', fontWeight: 600 }}>
                        {post.views || 0}
                      </td>
